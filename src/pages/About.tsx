          ...
          <div className="relative max-w-6xl mx-auto">
            <Card className="shadow-elegant animate-fade-in">
              ...
              <CardContent className="space-y-4 text-muted-foreground text-lg leading-relaxed">
                <p>
                  Welcome to <span className="font-bold text-primary">Riyadh Air Virtual</span> – the <span className="font-bold text-primary">next generation of virtual aviation</span> on Infinite Flight! Inspired by the real-world Riyadh Air, we're here to bring the <span className="font-bold text-primary">energy, culture, and ambition</span> of Saudi Arabia into the skies of the simulator. Founded in 2025, Riyadh Air Virtual was built on the belief that flying should be <span className="font-bold text-primary">exciting, community-driven, and truly global</span>.
                </p>
                <p>
                  At Riyadh Air Virtual, you'll experience the thrill of flying a <span className="font-bold text-primary">modern and versatile fleet</span>, including the <span className="font-bold text-primary">Boeing 787-9 Dreamliner</span> and the <span className="font-bold text-primary">Airbus A321neo</span>. Whether it's short regional hops across the Middle East or long-haul journeys to Europe, Asia, or Africa, our routes connect <span className="font-bold text-primary">Riyadh to the world</span>. With <span className="font-bold text-primary">King Khalid International Airport (OERK)</span> as our home base, every flight is a new opportunity to <span className="font-bold text-primary">explore, learn, and grow</span> with fellow aviation enthusiasts.
                </p>
                <p>
                  But what really makes Riyadh Air Virtual special is our <span className="font-bold text-primary">community</span>. We're more than just a VA – we're a <span className="font-bold text-primary">family of passionate pilots</span> who support each other, share our love for aviation, and celebrate every milestone together. From <span className="font-bold text-primary">events and group flights</span> to casual hangouts, Riyadh Air Virtual is all about <span className="font-bold text-primary">enjoying the journey</span>, not just the destination.
                </p>
                <p>
                  So, if you're looking for a virtual airline that combines <span className="font-bold text-primary">modern aircraft, exciting destinations, and a welcoming community</span>, then your next adventure starts here. Join Riyadh Air Virtual today, and be part of the <span className="font-bold text-primary">future taking flight</span>!
                </p>
